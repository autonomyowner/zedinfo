...
export default async function LocaleLayout({
  ...
  return (
    <html lang={loc} dir={dir} className={`${inter.variable} ${orbitron.variable}`}>
      <head>
      ...
      <body className="min-h-screen flex flex-col">
        <NextIntlClientProvider locale={loc} messages={messages}>
          <ConvexClientProvider>
            ...
            <a
              href="https://wa.me/213663287772"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="WhatsApp"
              className="fixed bottom-6 end-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg hover:scale-110 hover:shadow-xl transition-all"
            >
